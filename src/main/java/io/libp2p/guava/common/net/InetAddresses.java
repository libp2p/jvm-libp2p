package io.libp2p.guava.common.net;
...
import io.libp2p.guava.common.base.CharMatcher;
import io.libp2p.guava.common.base.MoreObjects;
import io.libp2p.guava.common.primitives.Ints;
import io.libp2p.guava.common.io.ByteStreams;
/*
...
public final class InetAddresses {
    ...
    public static Inet4Address getCompatIPv4Address(Inet6Address ip) {
        checkArgument(
                isCompatIPv4Address(ip), "Address is not IPv4-compatible.");
    ...
    public static Inet4Address get6to4IPv4Address(Inet6Address ip) {
        checkArgument(is6to4Address(ip), "Address is not a 6to4 address.");
    ...
    public static final class TeredoInfo {
        ...
        public TeredoInfo(Inet4Address server, Inet4Address client, int port, int flags) {
            checkArgument(
                    (port >= 0) && (port <= 0xffff), "port '%s' is out of range (0 <= port <= 0xffff)");
            checkArgument(
    ...
    public static Inet4Address getIsatapIPv4Address(Inet6Address ip) {
        checkArgument(isIsatapAddress(ip), "Address is not an ISATAP address.");
    ...
    public static InetAddress decrement(InetAddress address) {
        ...
        checkArgument(i >= 0, "Decrementing %s would wrap.");
    ...
    public static InetAddress increment(InetAddress address) {
        ...
        checkArgument(i >= 0, "Incrementing would wrap.");
