package io.libp2p.guava.common.io;
...
import static io.libp2p.guava.common.base.Preconditions.checkPositionIndex;
import static io.libp2p.guava.common.base.Preconditions.checkPositionIndexes;


import io.libp2p.guava.common.math.IntMath;
...
public final class ByteStreams {
    ...
    static byte[] toByteArray(InputStream in, long expectedSize) throws IOException {
        checkArgument(expectedSize >= 0, "expectedSize must be non-negative");
    ...
    /**
     * Returns a new ByteArrayDataInput instance to read from the {@code bytes} array from the
     * beginning.
     */
    ...
    /**
     * Returns a new ByteArrayDataInput instance to read from the {@code bytes} array,
    ...
    /**
     * Returns a new ByteArrayDataOutput instance sized to hold {@code size} bytes before
     * resizing.
     *
    ...
    /**
     * Returns a new ByteArrayDataOutput instance which writes to the given {@code
